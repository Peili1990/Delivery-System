...
LOCK TABLES `user_type_table` WRITE;
/*!40000 ALTER TABLE `user_type_table` DISABLE KEYS */;
INSERT INTO `user_type_table` VALUES (0,'SYS'),(1,'USER'),(2,'WORKER');
/*!40000 ALTER TABLE `user_type_table` ENABLE KEYS */;
UNLOCK TABLES;
